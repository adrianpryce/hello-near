...
let HelloNear = (_dec = NearBindgen({}), _dec2 = view(), _dec3 = call({}), _dec4 = view(), _dec5 = call({}), _dec6 = view(), _dec7 = call({}), _dec8 = view(), _dec9 = call({}), _dec(_class = (_class2 = class HelloNear {
  greeting = "Hello";
  amount = 0;
  contractView = false;
  test = {};
...
}, (_applyDecoratedDescriptor(_class2.prototype, "get_greeting", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "get_greeting"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "set_greeting", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "set_greeting"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_amount", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "get_amount"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "set_amount", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "set_amount"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_contract_view", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "get_contract_view"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "set_contract_view", [_dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "set_contract_view"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_view", [_dec8], Object.getOwnPropertyDescriptor(_class2.prototype, "get_view"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "set_view", [_dec9], Object.getOwnPropertyDescriptor(_class2.prototype, "set_view"), _class2.prototype)), _class2)) || _class);
function set_view() {
  ...
  const _result = _contract.set_view(_args);
...
function get_view() {
  ...
  const _args = HelloNear._getArgs();
  const _result = _contract.get_view(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(HelloNear._serialize(_result, true));
}
function set_contract_view() {
  const _state = HelloNear._getState();
  if (!_state && HelloNear._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = HelloNear._getArgs();
  const _result = _contract.set_contract_view(_args);
  HelloNear._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(HelloNear._serialize(_result, true));
}
function get_contract_view() {
  const _state = HelloNear._getState();
  if (!_state && HelloNear._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = HelloNear._getArgs();
  const _result = _contract.get_contract_view(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(HelloNear._serialize(_result, true));
}
function set_amount() {
  const _state = HelloNear._getState();
  ...
  const _args = HelloNear._getArgs();
  const _result = _contract.set_amount(_args);
  HelloNear._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(HelloNear._serialize(_result, true));
}
function get_amount() {
  ...
  const _args = HelloNear._getArgs();
  const _result = _contract.get_amount(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(HelloNear._serialize(_result, true));
}
...
export { get_amount, get_contract_view, get_greeting, get_view, set_amount, set_contract_view, set_greeting, set_view };
